...
Contributions to Cake.Karma are highly encouraged and desired. Below are some guidelines that will help make the process as smooth as possible.
...
We want to know what you think is missing from Cake.Karma and how it can be made better.
...
* To quickly create a topic branch based on develop; `git checkout -b my_contribution developer`. Please avoid working directly on the `develop` or `master` branch.
